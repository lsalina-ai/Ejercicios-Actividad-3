...
/**
 * Clase InterfazNotas: Interfaz gráfica de usuario para el ingreso de notas
 * y visualización de estadísticas calculadas.
 * @version 1.0/2026
 */
public class InterfazNotas extends JFrame implements ActionListener {
    ...
    private Notas notas; // Objeto del modelo

    /**
     * Constructor de la clase InterfazNotas
     */
    ...
    private void inicializarComponentes() {
        setTitle("Gestión de Notas - Universidad Nacional de Colombia");
        setSize(500, 480);
        ...
        JLabel titulo = new JLabel("Ingreso de Notas del Estudiante");
        titulo.setForeground(Color.WHITE);
        titulo.setFont(new Font("SansSerif", Font.BOLD, 16));
        panelTitulo.add(titulo);
        contenedor.add(panelTitulo, BorderLayout.NORTH);

        // Panel central: ingreso de notas
    ...
    /**
     * Maneja los eventos de los botones Calcular y Limpiar
     */
    @Override
